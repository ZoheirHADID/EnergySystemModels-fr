...
================================================================================
Section 7 : Concepts avancés
================================================================================

7.1. Gestion des erreurs et exceptions
---------------------------------------
...
.. code-block:: python
   ...
   try:
       pv_system = PVSystem(
           latitude=48.8566,
           longitude=2.3522,
           puissance_crete_kWc=-5.0  # Erreur : valeur négative
       )
...
7.2. Connexion aux APIs externes
---------------------------------
...
.. code-block:: python
   ...
   # Utilisation avec OpenWeatherMap
   from energysystemmodels.OpenWeatherMap import OpenWeatherMapClient
...
7.3. Visualisation et export de données
----------------------------------------
...
.. code-block:: python
   ...
   fig = plotter.plot_consumption_profile(
       data=consommation,
       title="Profil de consommation annuel",
       xlabel="Date",
...
7.4. Calculs parallélisés pour grandes simulations
---------------------------------------------------
...
.. code-block:: python
   ...
   # Simulation de nombreuses configurations
   ...
   calculator = ParallelCalculator(n_jobs=-1)  # Tous les cœurs
   resultats = calculator.map(simuler_configuration, configurations)
   
   print(f"Calculé {len(resultats)} configurations en parallèle")
