...
.. code-block:: python
   ...
   # ...existing code for facture and calculateur...
   ...
   # MU4, MU_DT, LU, CU4_ac, MU_ac : mêmes tarifs que CU4
...
.. code-block:: python
   ...
   # LU, CU_ac, LU_ac : mêmes tarifs que CU
...
.. code-block:: python
   ...
   # CU_pm, LU_pf, LU_pm : mêmes tarifs que CU_pf
