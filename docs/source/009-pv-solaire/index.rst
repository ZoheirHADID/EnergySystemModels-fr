...
Sortie ``pv.df`` (météo PVGIS, un module) :
...
* **temperature_model** : modèle thermique (``open_rack_glass_glass``,
...
Renvoie une synthèse pour l'ensemble du champ : puissance installée, surface,
production annuelle, puis les indicateurs économiques (CAPEX, OPEX, temps de
...
Affiche la production AC horaire (nulle la nuit, maximale en milieu de journée)
